...
public class IpRangeUnitTest {
    ...
    public void parseIPv4TestCase1() {
        ...
        try {
            IpRange range = IpRange.parseRange(address);
    ...
    public void parseIPv4TestCase3() {
        String address = "0.0";
        Assertions.assertThrowsExactly(SyntaxException.class, () -> IpRange.parseRange(address));
    }
    ...
    public void checkIPv4TestCase1() {
        try {
            IpRange range = IpRange.parseRange("0.0.0.0/0");
    ...
    public void checkIPv4TestCase2() {
        try {
            IpRange range = IpRange.parseRange("0.0.0.0");
            boolean test = range.test("192.168.0.1");
